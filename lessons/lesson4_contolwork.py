...
class MageHero(Hero):
    ...
    def action(self):
        return (f"Маг {self.name} кастует заклинание! MP: {self.mana}")
...
class BankAccount:
    ...
    def full_info(self):
        return (self._balance, self.hero)
...
print("Сумма мага и воина:", acc1 + acc2)
